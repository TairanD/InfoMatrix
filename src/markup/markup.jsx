...
import WeRaceAsOne from "./pages-infoMatrix/we-race-as-one";
import ShareYourFeeling from "./pages-infoMatrix/share-your-feeling";
import MyInfoMatrix from "./pages-infoMatrix/my-infomatrix";
import ShePosts from "./pages-infoMatrix/she-posts";
...
const routes = [
  ...
  { path: "/we-race-as-one", element: <WeRaceAsOne />},
  { path: "/share-your-feeling", element: <ShareYourFeeling />},
  { path: "/we-race-as-one/:id", element: <ShePosts />},

  // View Other Users
  { path: "/friends", element: <OtherUser />},
  ...
  { path: "/my-infomatrix", element: <MyInfoMatrix />},
